...
- `Машинка.png` — 4558×3869px RGBA, основная иллюстрация (прозрачный фон)
- `Машинка 4.png` — 4558×1727px RGBA, крупный план бумаги. **Другой угол съёмки**, не кроп Машинки.png — не использовать как позиционный сайзер
...
Перенести на Тильду: загрузить `Машинка.png` в медиабиблиотеку, поставить Zero Block (T396), добавить картинку и HTML-блок с кодом из `index.html`.
